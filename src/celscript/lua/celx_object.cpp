...
{
    CelxLua celx(l);
    celx.checkArgs(2, 3, "One or two arguments are expected for object:object_setcloudtexture()");
    ...
    if (*textureName == '\0')
    {
        celx.doError("Empty texture name passed to object:object_setcloudtexture()");
        return 0;
    }
